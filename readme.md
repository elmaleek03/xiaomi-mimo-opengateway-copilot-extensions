...
**Linux / macOS:**
```bash
curl -sL https://raw.githubusercontent.com/elmaleek03/xiaomi-mimo-opengateway-copilot-extensions/refs/head/master/install.sh | bash
```

**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/elmaleek03/xiaomi-mimo-opengateway-copilot-extensions/refs/head/master/install.ps1 | iex
```
